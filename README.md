...
<p></p>
Scan the QR code from your mirror and a empy page will show. <h4>NOTE! Edit the link and replace USERNAME and PASSWORD</h4> on you device you have scanned the qr code, edit the link and change it with your login information for next-episode to get id and hash. they might come together a one line but the first 9 digits are the id and the rest the hash.
